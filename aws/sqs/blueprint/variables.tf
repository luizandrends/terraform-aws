...
variable "sqs_legacy_dlq_name" {
  type        = string
  default     = null
  description = "The same of name, but can be used in case of you want use a custom name for example to import old resources."
}
...
variable "create_dlq" {
  type        = bool
  default     = false
  description = "Enable creation of dead queue sqs."
}
...
variable "arn_sqs_dead" {
  type        = string
  default     = null
  description = "ARN for SQS Dead."
}
